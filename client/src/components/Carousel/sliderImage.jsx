export const imagesSlider = [
  {
    ...
    description: "Encuentra los libros que necesitas para tus estudios",
    urls: "https://res.cloudinary.com/dzcpdipdg/image/upload/v1665333566/samples/slider-images/slider-4_jxhnnx.jpg",
  },
  {
